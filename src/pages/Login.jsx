...
export default function Login() {
  ...
  const { currentUser, loginGoogle, loginEmail, signupEmail } = useAuth();
      ...
      <div className="auth-overlay" style={{ background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(10px)' }}>
        <div className="auth-box">
          ...
          <p style={{textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: '#64748b'}}>
            ...
            <span style={{color: '#00b0f0', cursor: 'pointer', fontWeight: 'bold'}} onClick={() => { setIsLogin(!isLogin); setError(''); setMessage(''); }}>
