  ...
  return (
    <div style={{ height: '100vh', width: '100vw', background: '#0f172a', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: '24px', color: '#cbd5e1', lineHeight: '1.6', fontSize: '0.95rem' }}>
        <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#f8fafc', marginBottom: '16px' }}>Privacy Policy</h1>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>1. Information We Collect</h2>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>2. How We Use the Data</h2>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>3. Data Security</h2>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>4. Your Rights</h2>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>5. Policy Updates</h2>
