...
export default function TermsOfUse() {
  ...
  return (
    <div style={{ height: '100dvh', width: '100vw', background: '#0f172a', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* CONTENT */}
      <div style={{ padding: '24px', color: '#cbd5e1', lineHeight: '1.6', fontSize: '0.95rem' }}>
        <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#f8fafc', marginBottom: '16px' }}>Sabay Terms of Use</h1>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>1. Non-Profit Cost-Sharing & LTFRB Compliance</h2>
        <div style={{ background: 'rgba(245, 158, 11, 0.1)', padding: '16px', borderRadius: '8px', borderLeft: '4px solid #f59e0b', marginBottom: '16px' }}>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>2. Eligibility</h2>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>3. User Responsibilities</h2>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>4. Safety and Conduct</h2>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>5. Limitation of Liability</h2>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>6. Termination</h2>
        ...
        <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc', marginTop: '24px', marginBottom: '8px' }}>7. Governing Law</h2>
