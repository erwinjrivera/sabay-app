...
const PassengerEndPinIcon = ({ color = '#ea4335' }) => (
  <svg width="40" height="40" viewBox="0 0 24 24" fill={color} stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ filter: 'drop-shadow(0px 4px 4px rgba(0,0,0,0.3))' }}>
        ...
        const matchPromises = reqDocs.map(async (req) => {
           ...
           const dLat = req.to.lat;   const dLon = req.to.lon;
            ...
            try {
              ...
              // --- PICKUP & DROP-OFF: Road-network distance via OSRM Table API ---
